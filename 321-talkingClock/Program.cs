...
namespace _321_talkingClock
{
    class Program
    {
        ...
        private static void ConvertTimestampToSpeech()
        {
            string _inHour = "";
            string _inMinute = "";
            string _minuteTens = "";
            ...
            else if (_inputTimestamp.Length != 5 || _inputTimestamp[2] != ':')
            {
                ...
                s.Speak(_inputTimestamp + " is not in the valid format");
                continue;
            }
            ...
            if (_inMinute != "00")
            {
                ...
                s.Speak("The time is " + oaut + " " + minutes2 + " " + ones + " " + _amOrPm);
            }
            else
            {
                Console.WriteLine("It's " + oaut + " " + _amOrPm);
                s.Speak("The time is " + oaut + " " + _amOrPm);
